...
public class MaterialReceiveServiceImpl implements MaterialReceiveService {
	...
	@Override
	public PageResult searchMaterialReceiveByReceiveId(int page, int rows, String receiveId)
			throws Exception{
		//分页处理
		PageHelper.startPage(page, rows);
	...
	@Override
	public	PageResult searchMaterialReceiveByMaterialId(int page, int rows,String materialId)
			throws Exception{
		//分页处理
		PageHelper.startPage(page, rows);
